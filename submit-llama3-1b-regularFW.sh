...
#DATASETS="/capstor/store/cscs/swissai/a06/datasets_tokenized/nemo/sai/swissai-fineweb-edu-keeprobots"
...
EXP_NAME=llama3-1b-${SLURM_NNODES}n-${SEQ_LEN}sl-${GBS}gbsz-saiVocab-regularFW
