...
PATH_TO_PREPROCESSING_METADATA=/capstor/store/cscs/swissai/infra01/datasets_tokenized/swiss-caselaw-preprocessed # ⚠️ change
...
PATH_TO_OUTPUT_FOLDER=/capstor/store/cscs/swissai/infra01/datasets_tokenized/swiss-caselaw-preprocessed # ⚠️ Change Where tokenized datasets are stored
