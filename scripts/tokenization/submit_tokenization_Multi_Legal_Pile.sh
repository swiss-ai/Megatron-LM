...
DATASET_NAME=Multi_Legal_Pile-preprocessed # ⚠️ Change here
COLUMN_KEY=text
...
PATH_TO_PREPROCESSING_METADATA=/iopsstor/scratch/cscs/snajemmeyer/tokenized_datasets_apertus_1_5/swiss-ai/Multi_Legal_Pile-preprocessed # ⚠️ change
...
PATH_TO_OUTPUT_FOLDER=/iopsstor/scratch/cscs/snajemmeyer/tokenized_datasets_apertus_1_5/swiss-ai/Multi_Legal_Pile-preprocessed # ⚠️ Change Where tokenized datasets are stored
