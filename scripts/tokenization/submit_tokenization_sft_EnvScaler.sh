...
DATASET_NAME=EnvScaler-SFT-Traj-9K
COLUMN_KEY=text
...
PATH_TO_OUTPUT_FOLDER=/capstor/store/cscs/swissai/infra01/datasets_tokenized/apertus_sft_datasets/EnvScaler-SFT-Traj-9K
