...
DATASET_NAME=EnvScaler-SFT-Traj-9K_corr
COLUMN_KEY=text
...
MEGATRON_LM_DIR=/capstor/scratch/cscs/dtamayomela/megatron/pre-training/megatron_tok_or
...
PATH_TO_OUTPUT_FOLDER=/capstor/store/cscs/swissai/infra01/datasets_tokenized/apertus_sft_datasets/EnvScaler-SFT-Traj-9K_corr
