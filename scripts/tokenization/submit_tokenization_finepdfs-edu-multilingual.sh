...
DATASET_NAME=finepdfs-edu-multilingual-preprocessed # ⚠️ Change here
COLUMN_KEY=text
...
PATH_TO_PREPROCESSING_METADATA=/capstor/store/cscs/swissai/infra01/datasets_tokenized/finepdfs-edu-multilingual-preprocessed # ⚠️ change
...
PATH_TO_OUTPUT_FOLDER=/capstor/store/cscs/swissai/infra01/datasets_tokenized/finepdfs-edu-multilingual-preprocessed # ⚠️ Change Where tokenized datasets are stored
