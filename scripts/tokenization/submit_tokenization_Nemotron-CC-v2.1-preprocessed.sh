...
DATASET_NAME=Nemotron-CC-v2.1-preprocessed # ⚠️ Change here
COLUMN_KEY=text
...
PATH_TO_PREPROCESSING_METADATA=/capstor/store/cscs/swissai/infra01/datasets_tokenized/Nemotron-CC-v2.1-preprocessed # ⚠️ change
...
PATH_TO_OUTPUT_FOLDER=/capstor/store/cscs/swissai/infra01/datasets_tokenized/Nemotron-CC-v2.1-preprocessed # ⚠️ Change Where tokenized datasets are stored
