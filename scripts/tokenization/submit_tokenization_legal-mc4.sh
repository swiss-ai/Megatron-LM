...
DATASET_NAME=legal-mc4-preprocessed
COLUMN_KEY=text
...
PATH_TO_PREPROCESSING_METADATA=/iopsstor/scratch/cscs/snajemmeyer/tokenized_datasets_apertus_1_5/swiss-ai/legal-mc4-preprocessed
...
PATH_TO_OUTPUT_FOLDER=/iopsstor/scratch/cscs/snajemmeyer/tokenized_datasets_apertus_1_5/swiss-ai/legal-mc4-preprocessed # Where tokenized datasets are stored
