...
DATASET_NAME=Toucan-1.5M_filtered
COLUMN_KEY=text
...
PATH_TO_OUTPUT_FOLDER=/capstor/store/cscs/swissai/infra01/datasets_tokenized/apertus_sft_datasets/Toucan-1.5M_filtered
