...
DATASET_NAME=dolma3_olmocr_science_pdfs-preprocessed
COLUMN_KEY=text
...
MEGATRON_LM_DIR=/capstor/scratch/cscs/dtamayomela/megatron/pre-training/Megatron-LM
...
PATH_TO_OUTPUT_FOLDER=/capstor/scratch/cscs/dtamayomela/data/tokenized_data # Where tokenized datasets are stored
