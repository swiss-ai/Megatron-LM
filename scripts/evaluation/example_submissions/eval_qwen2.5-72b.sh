...
export ARGS="--size 70 --wandb-entity andreas-marfurt --wandb-project swissai-eval-main-v1.2 --wandb-id $NAME --bs auto --consumed-tokens 18000000000000 --tasks swissai_eval --limit 1000"
