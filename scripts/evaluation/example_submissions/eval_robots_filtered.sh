...
export MODEL=/iopsstor/scratch/cscs/dfan/Megatron-LM/logs/Meg-Runs/robotstxt_ablation_runs/apertus-1b-21n-4096sl-504gbsz-fw-edu-robots-filtered-plus-Top2-domains/checkpoints/
export NAME=robots-filtered-Top2-$(date '+%Y-%m-%d_%H-%M-%S')
