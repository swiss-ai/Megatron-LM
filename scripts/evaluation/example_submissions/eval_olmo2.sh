...
bash scripts/evaluation/submit_evaluation.sh $MODEL $ARGS --iterations $ITS --revisions stage1-step50000-tokens210B,stage1-step251000-tokens1053B,stage1-step502000-tokens2106B,stage1-step753000-tokens3159B,stage1-step928646-tokens3896B --attn-impl sdpa
